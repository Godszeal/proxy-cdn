  ...
  <div class="card">
    ...
    <div class="row">
      ...
      <div class="box">
        ...
        <div class="value"><a href="${process.env.VERCEL_URL ? "https://" + process.env.VERCEL_URL : "https://zst-proxy-cdn.vercel.app"}" target="_blank">${process.env.VERCEL_URL ? "https://" + process.env.VERCEL_URL : "https://zst-proxy-cdn.vercel.app"}</a></div>
      </div>
      <div class="box">
